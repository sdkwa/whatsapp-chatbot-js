const debug = require('debug')('@sdkwa/whatsapp-chatbot:core')
const Telegram = require('./telegram')
const SDKWA = require('./sdkwa')
...
class WhatsAppBot extends Composer {
  ...
  webhookCallback (path = '/') {
    return generateCallback(path, (update, res) => {
      return this.handleUpdate(this.telegram.mapToMessageUpdate(update)[0], res)
    }, debug)
  }
    ...
    return this.handleUpdate(
        { 
            message: {
                ...
                date: null,
                from: {first_name: '', last_name: '', id: 0, is_bot: false},
                message_id: '',
                text: text
            }, 
            update_id: 1111
