...
export declare class SDKWA extends ApiClient {
   ...
   * @param errorMessage Required if ok is False. Error message in human readable form that explains why it is impossible to complete the order (e.g. "Sorry, delivery to your desired address is unavailable'). SDKWA will display this message to the user.
   */
  answerShippingQuery(
   ...
   * @param errorMessage Required if ok is False. Error message in human readable form that explains the reason for failure to proceed with the checkout (e.g. "Sorry, somebody just bought the last of our amazing black T-shirts while you were busy filling out your payment details. Please choose a different color or garment!"). SDKWA will display this message to the user.
   */
  ...
  /**
   * Use this method to send audio files, if you want SDKWA clients to display them in the music player.
   * Your audio must be in the .mp3 format.
   * Bots can currently send audio files of up to 50 MB in size, this limit may be changed in the future.
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param audio Audio file to send. Pass a file_id as String to send an audio file that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get an audio file from the Internet, or upload a new one using multipart/form-data
   ...
   * The status is set for 5 seconds or less (when a message arrives from your bot, SDKWA clients clear its typing status).
   ...
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param document File to send. Pass a file_id as String to send a file that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get a file from the Internet, or upload a new one using multipart/form-data
   ...
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param photo Photo to send. Pass a file_id as String to send a photo that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get a photo from the Internet, or upload a new photo using multipart/form-data
   ...
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param animation Animation to send. Pass a file_id as String to send a GIF that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get a GIF from the Internet, or upload a new GIF using multipart/form-data
   ...
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param sticker Sticker to send. Pass a file_id as String to send a file that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get a .webp file from the Internet, or upload a new one using multipart/form-data
  ...
  /**
   * Use this method to send video files, SDKWA clients support mp4 videos (other formats may be sent as Document)
   * Bots can currently send video files of up to 50 MB in size, this limit may be changed in the future.
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param video video to send. Pass a file_id as String to send a video that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get a video from the Internet, or upload a new video using multipart/form-data
   ...
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param videoNote video note to send. Pass a file_id as String to send a video note that exists on the SDKWA servers (recommended) or upload a new video using multipart/form-data. Sending video notes by a URL is currently unsupported
  ...
  /**
   * Use this method to send audio files, if you want SDKWA clients to display the file as a playable voice message. For this to work, your audio must be in an .ogg file encoded with OPUS (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
   * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
   * @param voice Audio file to send. Pass a file_id as String to send a file that exists on the SDKWA servers (recommended), pass an HTTP URL as a String for SDKWA to get a file from the Internet, or upload a new one using multipart/form-data
  ...
  /**
   * Use this method to get updates from SDKWA server. Bot should be in `polling` mode
  ...
  mapToMessageUpdate(incomingMsg: any): any
}
